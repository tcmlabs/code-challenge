...
from exercices import string_monoid, integer_monoid_one, integer_monoid_two, boolean_monoid_one, boolean_monoid_two, list_monoid, function_monoid, integer_addition_property_one, integer_addition_property_two,  integer_multiplication_property_one,integer_multiplication_property_two
